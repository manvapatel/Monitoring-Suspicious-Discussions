...
MONGODB_PORT = 27017
MONGODB_DB = "TweetScraper1"        # database name to save the crawled data
MONGODB_TWEET_COLLECTION = "tweetScrap" # collection name to save tweets
MONGODB_USER_COLLECTION = "userScrap"   # collection name to save users
